                    ...
                    <ul class="site-menu" data-plugin="menu">
                        <li class="site-menu-item has-sub">
                            <a href="<?= base_url('auth'); ?>">
                                <span class="site-menu-title">Lapor Kecelakaan Kerja</span>
                            </a>
                        </li>
                        <li class="site-menu-item has-sub">
                            <a href="<?= base_url('rs') ?>">
                        ...
                        <li class="site-menu-item has-sub">
                            <a href="{{'itcs'}}">
                                <span class="site-menu-title">Cara Pelaporan</span>
                            </a>
                        </li>
                        <li class="site-menu-item has-sub">
                            <a href="{{'itcs'}}">
                ...
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <img src="<?= base_url() ?>assets/global/photos/gambarrr.png" alt="Random Name">
                        </div>
                        <div class="col-sm-4">
                            <p><strong>Name</strong></p><br>
                            <img src="<?= base_url() ?>assets/global/photos/gambarrr.png" alt="Random Name">

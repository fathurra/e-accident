                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="tanggal" value="<?= $l->tanggal; ?>" autocomplete="off" disabled />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-control-label" for="inputInlineUsername">Waktu Insiden</label>
                                        <input type="text" class="form-control" name="waktu" value="<?= $l->waktu; ?>" autocomplete="off" disabled />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        <label class="form-control-label" for="inputInlineUsername">Nama</label>
                                        <input type="text" class="form-control" name="nama" value="<?= $l->nama; ?>" autocomplete="off" disabled />
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label class="form-control-label" for="inputInlineUsername">Departemen</label>
                                        <input type="text" class="form-control" name="departemen" value="<?= $l->departemen; ?>" autocomplete="off" disabled />
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label class="form-control-label" for="inputInlineUsername">Jabatan</label>
                                        <input type="text" class="form-control" name="jabatan" value="<?= $l->jabatan; ?>" autocomplete="off" disabled />
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label class="form-control-label" for="inputInlineUsername">NIK</label>
                                        <input type="text" class="form-control" name="nik" value="<?= $l->nik; ?>" autocomplete="off" disabled />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="kat_karyawan" value="<?= $l->kat_karyawan; ?>" autocomplete="off" disabled />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <h6 class="example-title">Status Kecelakaan</h6>
                                        <h6 class="text-danger"><i>Berat / Sedang / Ringan </i></h6>
                                        <input type="text" class="form-control" name="status_kecelakaan" value="<?= $l->status_kecelakaan; ?>" autocomplete="off" disabled />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <h6 class="example-title">Kerja Shift</h6>
                                        <h6 class="text-danger"><i>Siang / Malam </i></h6>
                                        <input type="text" class="form-control" name="kerja_shift" value="<?= $l->kerja_shift; ?>" autocomplete="off" disabled />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" name="usia" value="<?= $l->usia; ?>" autocomplete="off" disabled /> <br>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="form-control-label" for="inputInlineUsername">Tanggal Masuk Kerja</label>
                                        <input type="text" class="form-control" name="masuk_kerja" value="<?= $l->masuk_kerja; ?>" autocomplete="off" disabled /> <br>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="form-control-label">Jenis Kelamin </label>
                                        <input type="text" class="form-control" name="jenis_kelamin" value="<?= $l->jenis_kelamin; ?>" autocomplete="off" disabled /> <br>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="bagian_terluka" class="form-control" id="textareaDefault" rows="4" disabled><?= $l->bagian_terluka; ?> </textarea>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="form-control-label" for="inputInlineUsername">Penanganan</label>
                                        <textarea name="penanganan" class="form-control" id="textareaDefault" rows="1" disabled><?= $l->penanganan; ?></textarea>
                                        <label class="form-control-label" for="inputInlineUsername">Perawatan</label>
                                        <textarea name="perawatan" class="form-control" id="textareaDefault" rows="1" disabled><?= $l->perawatan; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    " disabled><?= $l->kond_tdk_aman; ?></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                    ...
                                    " disabled><?= $l->tind_tdk_aman; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <textarea class="form-control" name="tind_perbaikan" id="tind_perbaikan" rows="3" disabled><?= $l->tind_perbaikan; ?></textarea>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="form-control-label" for="pic">PIC</label>
                                        <textarea class="form-control" name="pic" id="pic" rows="3" disabled><?= $l->pic; ?></textarea>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label class="form-control-label" for="target">Target</label>
                                        <textarea class="form-control" name="target" id="target" rows="3" disabled><?= $l->target; ?></textarea>
                                    </div>
                                </div>
                                <a href="<?= base_url('lik'); ?>" class="btn btn-info"><i class="icon fa-rotate-left" aria-hidden="true"></i> Back</a>
                                <a href="<?= base_url() . 'lik/lik_data_edit/' . $l->id_lik; ?>" class="btn btn-warning"><i class="icon fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                <a href="<?= base_url() . 'lik/lik_data_print/' . $l->id_lik; ?>" class="btn btn-success"><i class="icon fa-print" aria-hidden="true"></i> Print </a>
                            </form>
                        <?php } ?>
                    </div>
                </div>
